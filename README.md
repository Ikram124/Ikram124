...
<img align="right" src="https://media.giphy.com/media/3o7aD2saalBwwftBIY/giphy.gif" width="260" alt="Cybersecurity GIF" />

<h2>⚡️ A Few Quick Facts</h2>
<ul>
<li>🕵️‍♀️ Passionate about <strong>Network Security</strong>, <strong>Penetration Testing</strong>, and <strong>Incident Response</strong>.</li>
<li>🎯 Currently enhancing skills in <strong>Malware Analysis</strong> and <strong>Digital Forensics</strong>.</li>
<li>🧠 Researching <strong>Cryptographic Algorithms</strong> and <strong>Data Privacy</strong>.</li>
<li>💻 Actively practicing challenges on <a href="https://tryhackme.com/">TryHackMe</a> and <a href="https://www.hackthebox.com/">HackTheBox</a>.</li>
<li>📚 Completed <strong>Google Cybersecurity Certificate</strong> and working on <strong>CompTIA Security+</strong>.</li>
<li>🌍 Multilingual: Arabic 🇩🇿 | English 🇬🇧 | French 🇫🇷 | Korean 🇰🇷</li>
<li>🎉 Fun fact: I love combining tech & creativity — from scripting exploits to designing secure systems.</li>
</ul>
...
<img src="https://www.svgrepo.com/show/353904/burp-suite.svg" width="30" height="30" alt="Burp Suite" />
<img src="https://upload.wikimedia.org/wikipedia/commons/5/5f/Wireshark_Logo.svg" width="30" height="30" alt="Wireshark" />
<img src="https://upload.wikimedia.org/wikipedia/commons/2/2b/Kali-dragon-icon.svg" width="30" height="30" alt="Kali Linux" />
<img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vscode/vscode-original.svg" width="30" height="30" alt="VSCode" />
<img src="https://upload.wikimedia.org/wikipedia/commons/e/e9/Splunk_logo.svg" width="55" height="30" alt="Splunk" />
<img src="https://www.vectorlogo.zone/logos/elastic/elastic-icon.svg" width="30" height="30" alt="ELK Stack" />
</p>

<h2>📊 GitHub Stats</h2>
<p align="center">
<img src="https://github-readme-stats.vercel.app/api?username=Ikram124&show_icons=true&theme=radical" alt="GitHub Stats" />
</p>
...
<details>
  ...
  <ul>
    <li><a target="_blank" href="https://github.com/Ikram124/WebAppSecurity-Audit">🔐 Web App Security Audit – OWASP Testing Project</a></li>
    <li><a target="_blank" href="https://github.com/Ikram124/SecureShop-DBSecurity">🧮 SecureShop Database Security Management</a></li>
    <li><a target="_blank" href="https://github.com/Ikram124/WindowsServer-Hardening">🖥️ Windows Server Hardening & Policy Enforcement</a></li>
    <li><a target="_blank" href="https://github.com/Ikram124/Merkle-Hellman-Cryptosystem">🔢 Merkle–Hellman Cryptosystem Implementation</a></li>
  </ul>
</details>
